...
#(
  ...
  assign resp_ack = tlul_en_i & tl_o.d_ready & tl_i.d_valid;
  ...
  assign tl_o_pre = '{
    a_valid: tlul_en_i & ~pending_q,
    a_opcode: ~tlul_write_i ? Get : PutFullData,
    a_size: 2'b10,
    a_mask: 4'b1111,
    a_source: '0,
    a_address: tlul_addr_i,
    a_data: tlul_wdata_i,
  ...
  assign tlul_wait_o  = pending_q && tl_o.d_ready && tl_i.d_valid ? 1'b0 : 1'b1;
  assign tlul_rdata_o = tl_i.d_data;
  assign tlul_error_o = tl_i.d_error | intg_err_chk;
