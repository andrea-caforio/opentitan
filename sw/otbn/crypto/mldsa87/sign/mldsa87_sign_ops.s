 ...
 * on the lower-bit polynomials W0 of the commitment vector W. This choice
 * makes it possible to completely unmask R0 after it has passed the bound
 * check. For more details on this implementation choice see Section 3.2 in
 * Azouaoui et al. paper "Protecting Dilithium against Leakage":
...
_compute_r0_loop:
 ...
 /* Compute the infinity norm check on the shared R0[r] polynomial and exit
  ...
  /* Failure case, a R= polynomial has failed the infinity norm check. */
_compute_r0_fail:
  bn.xor w0, w0, w0
