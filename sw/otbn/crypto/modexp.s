 ...
 *
 * Importantly for this blinding countermeasure, the exponent needs to be
 * provided in two Boolean shares such that
 *
 *   d0 XOR d1 = d-1
 *
 ...
 * @param[in] x26: dptr_d0, DMEM pointer to the first share of exponent d-1
 * @param[in] x27: dptr_d1, DMEM pointer to the second share of the exponent d-1
 ...
 **********************************************************/
  ...
  /* Map the blinding factor R into the Montgomery domain and store it back. */
  addi      x16, x28, 0
  addi      x19, x24, 0
  addi      x20, x29, 0
  jal       x1, montmul
